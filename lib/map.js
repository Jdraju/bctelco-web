...
var popup = new mapboxgl.Popup({closeOnClick: false})
    .setLngLat([-96, 37.8])
    .setHTML(
        '<h3>MSIDN:1469xxxxxxx1</h3><button> Call In</button> <br/> <button>Call Out</button>'
        )
    .addTo(map);

var popup = new mapboxgl.Popup({closeOnClick: false})
    .setLngLat([2.173403, 41.385064])
    .setHTML(
        '<h3>MSIDN:1469xxxxxxx2</h3><button> Call In</button> <br/> <button>Call Out</button>'
        )
    .addTo(map);
var popup = new mapboxgl.Popup({closeOnClick: false})
    .setLngLat([-96.994838,32.942746])
    .setHTML(
        '<h3>MSIDN:1469xxxxxxx3</h3><button> Call In</button> <br/> <button>Call Out</button>'
        )
    .addTo(map);
